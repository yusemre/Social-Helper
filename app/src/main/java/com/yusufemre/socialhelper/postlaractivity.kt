...
import kotlinx.android.synthetic.main.activity_postlaractivity.*
...
class postlaractivity : AppCompatActivity() {
    ...
    var adpater: postlaractivity.MyPostlarAdpater? = null
    var myname: String? = null
    var UserUID: String? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_postlaractivity)
        ...
        adpater= MyPostlarAdpater(this,ListPosts)
    ...
    inner class MyPostlarAdpater : BaseAdapter {
        ...
        override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
            ...
            if (mypost.postPersonUID.equals("add")) {
                ...
                myView.iv_post.setOnClickListener(View.OnClickListener {
                   ...
                   // myRef!!.child("pos").child(uid).push().setValue(yenipost)
                    myRef!!.child("pos").child(FirebaseAuth.getInstance().uid).setValue(yenipost)
                    myView.etPost.setText("")
                    SaveImageInFirebase()
                ...
                Picasso.with(this@postlaractivity).load(mypost.postImageURL).into(myView.tweet_picture)


                myRef.child("pos").child(FirebaseAuth.getInstance().currentUser?.uid)
    ...
    fun SaveImageInFirebase(){
        ...
        val ImageRef=storgaRef.child("imagepostlar/"+imagePath )
        ...
        uploadTask.addOnFailureListener{
            Toast.makeText(applicationContext,"fail to upload", Toast.LENGTH_LONG).show()
                    ...
                    myRef.child("pos").child(FirebaseAuth.getInstance().uid).child("postImage").setValue(DownloadURL)
